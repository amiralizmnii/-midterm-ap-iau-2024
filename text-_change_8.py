...
with open('output.txt', 'w', encoding='utf-8') as f:
    f.write(f"Number of repetitions of each letter and number : {char_counts}\n")
    f.write(f"Number of words : {word_count}\n")
    f.write(f"Number of sentences : {sentence_count}\n")
    f.write(f"Number of paragraphs : {paragraph_count}\n")
    f.write(f"The number of each English vowel : {vowel_counts}\n")
    f.write(f"Number of silent letters : {consonant_count}\n")
    f.write(f"Variance of the number of vowels in each sentence : {sentence_vowel_variance:.2f}\n")
    f.write(f"Variance of the number of vowels in each paragraph : {paragraph_vowel_variance:.2f}\n")
    f.write(f"Variance of the number of vowels in the whole text : {total_vowel_variance:.2f}\n")
